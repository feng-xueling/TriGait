            ...
            for _view in os.listdir(type_path):
                ...
                for _seq in os.listdir(view_path):
                    ...
                    link_method(sils_seq_path, os.path.join(
                        output_seq_path, "asils-"+_seq))
                    link_method(smpls_seq_path, os.path.join(
                        output_seq_path, "poses-"+_seq))


if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Gait3D dataset mergence.')
    parser.add_argument('--sils_path', default='/data/GaitData/CASIA-B/CASIA-B-sil/', type=str,
                        help='Root path of raw silhs dataset.')
    parser.add_argument('--smpls_path', default='/data/GaitData/CASIA-B/CASIA-B-pose-pkl/', type=str,
                        help='Root path of raw smpls dataset.')
    parser.add_argument('-o', '--output_path', default='/data/GaitData/CASIA-B/CASIA-B-sil-pose/',
