...
from ..modules import SeparateFCs, BasicConv2d, PackSequenceWrapper, Attention, FusePart3,SeparateBNNecks,HorizontalPoolingPyramid
...
class TriGait_Gait3D_2dbackbone_woTS(BaseModel):
    def __init__(self, cfgs, is_training):
        super().__init__(cfgs, is_training)

    def build_network(self, model_cfg):
        sil_channels = model_cfg['channels']
        #self.ES = backbone_3d(_in_channels=1,in_c=sil_channels)
        ...
        fuse_channel = 768
        self.fuse = FusePart3(sil_channels[0],in_c2[1],out_c=fuse_channel,atten_depth=4)
        ...
        self.Head1 = SeparateFCs(71, hidden_dim, model_cfg['class_num'])'''
        '''
        hidden_dim = model_cfg['hidden_dim']
        sil_dim = sil_channels[-1]*2+in_c2[-1]
        self.Head0 = SeparateFCs(71, sil_dim, hidden_dim)
        self.Bn = nn.BatchNorm1d(hidden_dim)
        self.Head1 = SeparateFCs(71, hidden_dim, model_cfg['class_num'])'''
    ...
    def forward(self, inputs):
        ...
        fuse = self.fuse(fuse_sil,fuse_pose)  #n,p,c
