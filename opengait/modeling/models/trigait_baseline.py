...
from ..modules import SeparateFCs, BasicConv3d, PackSequenceWrapper, Attention, DividPart, FusePart3,SeparateBNNecks,HorizontalPoolingPyramid
...
class TriGait_baseline2(BaseModel):
    ...
    def heatmap(self,target):
        ...
        output_directory = r'/code/CodeTest/fxl/Opengait/heatmap/'
        import os
        output_path = os.path.join(output_directory, 'mean.png')
        import cv2
    ...
    def build_network(self, model_cfg):
        ...
        self.fuse = FusePart3(sil_channels[0], in_c2[1], out_c=fuse_channel, atten_depth=2)
