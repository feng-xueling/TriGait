...
class DataSet(tordata.Dataset):
    ...
    def __loader__(self, paths):
        ...
        if self.data_cfg['dataset_name'] !="Gait3D":
            r = data_list[0].shape[0] // data_list[1].shape[0]
            data_list[1] = numpy.repeat(data_list[1], r + 1, axis=0)
